...
export function MatchResultCard({ image_url, final_category, score, location, reported_time, isBestMatch }) {
    ...
    return (
        <div className={`group relative w-full overflow-hidden rounded-2xl border transition-all duration-300 hover:scale-[1.02] ${isBestMatch
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div>
                        <div className="flex justify-between items-start">
                            <h3 className="text-sm font-semibold text-white truncate pr-2">{title}</h3>
                            <div className={`flex items-center gap-1 text-[10px] font-bold px-1.5 py-0.5 rounded-full ${confidence > 90
