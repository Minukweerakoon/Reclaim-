...
const formatPercent = (value) => Math.round(normalizeScore(value) * 100);
...
function ValidationHub() {
    ...
    const [_entityResult, setEntityResult] = useState(null);
    ...
    const handleSubmitFeedback = async () => {
        ...
        try {
            const response = await feedbackApi.submitFeedback({
                ...
                original_prediction: currentResult,
    ...
    const entitiesPreview = useMemo(() => {
        ...
        return Object.entries(merged).slice(0, 6);
    ...
    const temporalHeatmap = useMemo(() => {
        ...
        const matrix = Array.from({ length: days }, () => Array.from({ length: buckets }, () => []));
