...
// __dirname is Voshan/src → one level up is Voshan, then ml-service/outputs/alert_frames
const alertFramesDir = path.resolve(__dirname, '../ml-service/outputs/alert_frames');
